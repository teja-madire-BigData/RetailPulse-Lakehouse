...
with DAG(
    dag_id = "silver_users",
    description = "Bronze to Silver: processing for users",
    schedule = "0 2 * * *",
        ...
        steps = [{
            ...
            "HadoopJarStep": {
                ...
                "Args": [
                    ...
                    f"{SCRIPTS_PATH}/silver_users.py",
    ...
    wait_step = EmrStepSensor(
        task_id = "wait_silver_users",
        job_flow_id = CLUSTER_ID,
        step_id = "{{ task_instance.xcom_pull('add_silver_users_step')[0] }}",
        aws_conn_id = "aws_default",
        poke_interval = 30,
        timeout = 3600,
