...
with DAG(
    ...
    description = "Bronze to Silver: SCD Type 1 upsert for products",
    schedule = "0 2 * * *",
    ...
    add_step = EmrAddStepsOperator(
        task_id = "add_silver_products_step",
        ...
        steps = [{
            ...
            "HadoopJarStep": {
                ...
                "Args": [
                    ...
                    f"{SCRIPTS_PATH}/silver_products.py",
    ...
    task_id = "wait_silver_products",
    job_flow_id = CLUSTER_ID,
    step_id = "{{ task_instance.xcom_pull('add_silver_products_step')[0] }}",
    aws_conn_id = "aws_default",
    poke_interval = 30,
    timeout = 3600,
